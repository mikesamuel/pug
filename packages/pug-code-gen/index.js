...
function Compiler(node, options) {
  ...
  this.bufferHooksExperimental = options.bufferHooksExperimental || {
...
Compiler.prototype = {
  ...
  compile: function(){
    this.buf = [];
    var initCode = this.bufferHooksExperimental.initialize(
    ...
    return buildRuntime(this.runtimeFunctionsUsed) + 'function ' + (this.options.templateName || 'template') + '(locals) {var ' + initCode + ', pug_mixins = {}, pug_interp;' + js + ';return ' + this.bufferHooksExperimental.result() + ';}';
  },
  ...
  buffer: function (str) {
    this.bufferHooksExperimental.emitText(str);
  },
  ...
  bufferExpression: function (src, safe, needsEscape) {
    ...
    this.bufferHooksExperimental.emitExpr(src, safe === true, needsEscape);
  },
  ...
  prettyIndent: function(offset, newline){
    ...
    if (this.parentIndents) {
      this.bufferHooksExperimental.emitExpr('pug_indent.join("")', true);
    }
  },
  ...
  visitComment: function(comment){
    ...
    // This occurs if comment.val contains the substring "-->", or
    // starts with the substrings ">" or "->".
  ...
  visitAttributes: function(attrs, attributeBlocks){
    if (attributeBlocks.length) {
      var dynamicFilter = this.bufferHooksExperimental.attrMapFilter();
      if (dynamicFilter) {
  ...
  attrs: function(attrs, buffer){
    var res = compileAttrs(attrs, {
      ...
      bufferHooksExperimental: this.bufferHooksExperimental
    });
    if (buffer)  {
