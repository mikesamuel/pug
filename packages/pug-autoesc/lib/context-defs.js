...
/** No element.  @const */
const ELEMENT_TYPE_NONE = 0;

/** A script element whose content is raw JavaScript.  @const */
const ELEMENT_TYPE_SCRIPT = 1 << 5;

/** A script element whose content is raw content of unknown type.  @const */
const ELEMENT_TYPE_SCRIPT_CUSTOM = 2 << 5;

/** A style element whose content is raw CSS.  @const */
const ELEMENT_TYPE_STYLE = 3 << 5;
 ...
 * @const
 */
const ELEMENT_TYPE_TEXTAREA = 4 << 5;
...
/** No attribute.  @const */
const ATTR_TYPE_NONE = 0;

/** Mime-type text/javascript.  @const */
const ATTR_TYPE_SCRIPT = 1 << 9;

/** Mime-type text/css.  @const */
const ATTR_TYPE_STYLE = 2 << 9;

/** A URI or URI reference.  @const */
const ATTR_TYPE_URI = 3 << 9;
 ...
 * @const
 */
const ATTR_TYPE_PLAIN_TEXT = 4 << 9;

/** All of the attribute type bits set.  @const */
const ATTR_TYPE_ALL = 7 << 9;
...
const DELIM_TYPE_NONE = 0;

/** {@code "}  @const */
const DELIM_TYPE_DOUBLE_QUOTE = 1 << 12;

/** {@code '}  @const */
const DELIM_TYPE_SINGLE_QUOTE = 2 << 12;

/** A space or {@code >} symbol.  @const */
const DELIM_TYPE_SPACE_OR_TAG_END = 3 << 12;

/** All of the delimiter type bits set.  @const */
const DELIM_TYPE_ALL = 3 << 12;
 ...
 * @const
 */
const JS_FOLLOWING_SLASH_UNKNOWN = 3 << 14;

/** All of the JS following slash bits set.  @const */
const JS_FOLLOWING_SLASH_ALL = 3 << 14;
 ...
 * @const
 */
const ESC_MODE_ESCAPE_HTML_RCDATA = 1;
 ...
 * @const
 */
const ESC_MODE_ESCAPE_HTML_ATTRIBUTE = 2;
 ...
 * @const
 */
const ESC_MODE_ESCAPE_HTML_ATTRIBUTE_NOSPACE = 3;
 ...
 * @const
 */
const ESC_MODE_FILTER_HTML_ELEMENT_NAME = 4;
 ...
 * @const
 */
const ESC_MODE_FILTER_HTML_ATTRIBUTE = 5;
 ...
 * @const
 */
const ESC_MODE_ESCAPE_JS_STRING = 6;
 ...
 * @const
 */
const ESC_MODE_ESCAPE_JS_VALUE = 7;
 ...
 * @const
 */
const ESC_MODE_ESCAPE_JS_REGEX = 8;
 ...
 * @const
 */
const ESC_MODE_ESCAPE_CSS_STRING = 9;
 ...
 * @const
 */
const ESC_MODE_FILTER_CSS_VALUE = 10;
 ...
 * @const
 */
const ESC_MODE_NORMALIZE_URI = 12;
 ...
 * @const
 */
const ESC_MODE_FILTER_NORMALIZE_URI = 13;

/**
 * The explicit rejection of escaping.
 * @const
 */
const ESC_MODE_NO_AUTOESCAPE = 14;
...
const IS_ESC_MODE_HTML_EMBEDDABLE = [];
 ...
 * @const
 */
const CONTENT_KIND_JS_STR_CHARS = 1;

/** A properly encoded portion of a URI.  @const */
const CONTENT_KIND_URI = 2;


const CONTENT_KIND_FOR_ESC_MODE = [];
...
module.exports = Object.freeze({
  ATTR_TYPE_ALL: ATTR_TYPE_ALL,
  ATTR_TYPE_NONE: ATTR_TYPE_NONE,
  ATTR_TYPE_PLAIN_TEXT: ATTR_TYPE_PLAIN_TEXT,
  ATTR_TYPE_SCRIPT: ATTR_TYPE_SCRIPT,
  ATTR_TYPE_STYLE: ATTR_TYPE_STYLE,
  ATTR_TYPE_URI: ATTR_TYPE_URI,
  CONTENT_KIND_FOR_ESC_MODE: CONTENT_KIND_FOR_ESC_MODE,
  CONTENT_KIND_HTML: CONTENT_KIND_HTML,
  CONTENT_KIND_JS_STR_CHARS: CONTENT_KIND_JS_STR_CHARS,
  CONTENT_KIND_URI: CONTENT_KIND_URI,
  DELIM_TEXT: DELIM_TEXT,
  DELIM_TYPE_ALL: DELIM_TYPE_ALL,
  DELIM_TYPE_DOUBLE_QUOTE: DELIM_TYPE_DOUBLE_QUOTE,
  DELIM_TYPE_NONE: DELIM_TYPE_NONE,
  DELIM_TYPE_SINGLE_QUOTE: DELIM_TYPE_SINGLE_QUOTE,
  DELIM_TYPE_SPACE_OR_TAG_END: DELIM_TYPE_SPACE_OR_TAG_END,
  ELEMENT_TYPE_ALL: ELEMENT_TYPE_ALL,
  ELEMENT_TYPE_LISTING: ELEMENT_TYPE_LISTING,
  ELEMENT_TYPE_NONE: ELEMENT_TYPE_NONE,
  ELEMENT_TYPE_NORMAL: ELEMENT_TYPE_NORMAL,
  ELEMENT_TYPE_SCRIPT: ELEMENT_TYPE_SCRIPT,
  ELEMENT_TYPE_SCRIPT_CUSTOM: ELEMENT_TYPE_SCRIPT_CUSTOM,
  ELEMENT_TYPE_STYLE: ELEMENT_TYPE_STYLE,
  ELEMENT_TYPE_TEXTAREA: ELEMENT_TYPE_TEXTAREA,
  ELEMENT_TYPE_TITLE: ELEMENT_TYPE_TITLE,
  ELEMENT_TYPE_XMP: ELEMENT_TYPE_XMP,
  ...
  ESC_MODE_FILTER_HTML_ATTRIBUTE: ESC_MODE_FILTER_HTML_ATTRIBUTE,
  ESC_MODE_FILTER_HTML_ELEMENT_NAME: ESC_MODE_FILTER_HTML_ELEMENT_NAME,
  ...
  IS_ESC_MODE_HTML_EMBEDDABLE: IS_ESC_MODE_HTML_EMBEDDABLE,
  JS_FOLLOWING_SLASH_ALL: JS_FOLLOWING_SLASH_ALL,
  JS_FOLLOWING_SLASH_DIV_OP: JS_FOLLOWING_SLASH_DIV_OP,
  JS_FOLLOWING_SLASH_NONE: JS_FOLLOWING_SLASH_NONE,
  JS_FOLLOWING_SLASH_REGEX: JS_FOLLOWING_SLASH_REGEX,
  JS_FOLLOWING_SLASH_UNKNOWN: JS_FOLLOWING_SLASH_UNKNOWN,
  STATE_ALL: STATE_ALL,
  STATE_CSS: STATE_CSS,
  ...
  STATE_URI: STATE_URI,
  URI_PART_ALL: URI_PART_ALL,
  URI_PART_FRAGMENT: URI_PART_FRAGMENT,
  URI_PART_NONE: URI_PART_NONE,
  URI_PART_PRE_QUERY: URI_PART_PRE_QUERY,
  URI_PART_QUERY: URI_PART_QUERY,
  URI_PART_START: URI_PART_START,
  URI_PART_UNKNOWN: URI_PART_UNKNOWN,
  URI_PART_UNKNOWN_PRE_FRAGMENT: URI_PART_UNKNOWN_PRE_FRAGMENT,
  attrTypeOf: attrTypeOf,
  delimTypeOf: delimTypeOf,
  elementTypeOf: elementTypeOf,
  isErrorContext: isErrorContext,
  jsFollowingSlashOf: jsFollowingSlashOf,
  stateOf: stateOf,
  uriPartOf: uriPartOf,
});
